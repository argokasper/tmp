...
public class Currency implements java.io.Serializable {
    ...
    private static java.util.HashMap<String, Currency> _table_ = new java.util.HashMap<String, Currency>();
    ...
    public static java.util.HashMap<String, Currency> getTable() {
    	return _table_;
    }
